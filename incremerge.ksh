...
function create_catalog {
     ...
     print "CATALOG START WITH '$data_root_dir/datafile.$DATE_SUFFIX' noprompt;" >> $catalog_ksh 
     print "CATALOG START WITH '$data_root_dir/datafile.recent' noprompt;" >> $catalog_ksh 

...
function show_usage {
echo "usage: incremerge-fastcopy.ksh -d <Data Domain> -u <DD User> -m <Mount Point> -h <host> -o <Oracle_sid> -t <
mtree> -k <retention lock days>"
echo " -d : Data Domain"
...
echo "Fastcopy Oracle datafiles in  $mount/$host/$oraclesid/incre/datafile to $mount/$host/$oraclesid/incre/datafi
le.$DATE_SUFFIX" >> $runlog
echo "Fastcopy Oracle datafiles in  $mount/$host/$oraclesid/incre/datafile to $mount/$host/$oraclesid/incre/datafi
le.recent" >> $runlog
...
ssh $user@$dd "filesys fastcopy source $mtree/$host/$oraclesid/incre/datafile destination $mtree/$host/$oraclesid/
incre/datafile.$DATE_SUFFIX force"
ssh $user@$dd "filesys fastcopy source $mtree/$host/$oraclesid/incre/datafile destination $mtree/$host/$oraclesid/
incre/datafile.recent force"
